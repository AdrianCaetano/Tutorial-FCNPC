### Olá, eu me chamo Adrian, e nesse tutorial iremos aprender a criar um npc jogavel para o teu servidor de samp utilizando sua gamemode pawn,usando a própria linguagem pawn para programar-lo.
